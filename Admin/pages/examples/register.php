...
<head>
  ...
  <title>CONNECTED | Registration Page</title>
...
<body class="hold-transition register-page body-bg">
<div class="register-box">
  ...
  <div class="register-box-body">
    ...
    <form onsubmit="return false">
      ...
      <div class="form-group has-feedback top-margin3">
        <div  class="checkbox icheck gender-check-box">
          <label class="gender-label"><b>Gender</b></label>
          <label class="box-margin"><input id ="gender" name="gender" value="M" type="radio"> Male</label>
          <label class="box-margin"><input name="gender" id="gender" value="F" type="radio"> Female</label>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button  class="btn btn-primary btn-block btn-flat" onclick="registerPerson()" > Register</button>
        </div>
        <!-- /.col -->
      </div>

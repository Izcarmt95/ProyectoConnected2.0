...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="butt on">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown notifications-menu">
            ...
            <ul class="dropdown-menu">
              <li class="footer"><a href="../../pages/examples/notifications.php">View all</a></li>
            </ul>
          </li>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="../examples/people.php">
            <i class="fa fa-users"></i> <span>People</span>
          </a>
        </li>
        
        <li class="treeview">
          <a href="../examples/notifications.php">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Mailbox
        <small># of Messages in Database</small>
      </h1>
      <ol class="breadcrumb">
